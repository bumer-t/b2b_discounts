...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Period.status'
        db.alter_column(u'discounts_period', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Period.status'
        db.alter_column(u'discounts_period', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))
